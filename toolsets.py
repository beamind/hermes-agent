...
_HERMES_CORE_TOOLS = [
    ...
    # Smart Speaker local music playback (gated on SMART_SPEAKER_MUSIC_LIBRARY_PATH via check_fn)
    "play_music", "control_playback", "get_playback_status",
]
...
TOOLSETS = {
    ...
    "tts": {
        "description": "Text-to-speech: convert text to audio with Edge TTS (free), ElevenLabs, OpenAI, xAI, MiniMax, Mistral, Gemini, DashScope, NeuTTS, or KittenTTS",
    ...
    "hermes-voice": {
        "description": "Local voice assistant toolset - smart speaker with wake word, ASR, and TTS",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-gateway": {
        ...
        "tools": [],
        "includes": ["hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal", "hermes-bluebubbles", "hermes-homeassistant", "hermes-email", "hermes-sms", "hermes-mattermost", "hermes-matrix", "hermes-dingtalk", "hermes-feishu", "hermes-wecom", "hermes-wecom-callback", "hermes-weixin", "hermes-qqbot", "hermes-voice", "hermes-webhook"]
    }
}
